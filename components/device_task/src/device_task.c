...
//     DELAY_UPDATE_FORECAST   = 45*TIMEOUT_MINUTE,
//     INTERVAL_UPDATE_DATA    = 450*TIMEOUT_MINUTE,
...
//                         }
//                         start_signale_series(70, 20, 2000);
//                         cmd = CMD_UPDATE_DATA;
...
//                     stop_sntp();
//                 }
//                 esp_res = update_forecast_data(device_get_chat_id(),device_get_token());
//             }
//             if(esp_res == ESP_OK){
